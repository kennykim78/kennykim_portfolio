...
function moveScrollTop2 (targetY, duration) {
...
function toAnchorParameter(anchor) {
	...
	if ( getParameter(anchor) ) {
		...
		var anchorConTop;
		if($(window).width() > 801) {
			anchorConTop = $("#"+getParameter(anchor)+"").offset().top;
		}else{
			anchorConTop = $("#"+getParameter(anchor)+"").offset().top - $('#header').height();
		}

		moveScrollTop(anchorConTop, 1200);
...
function smoothScroll_destory (event) {
	...
	if (window.winScrolling) { window.winScrolling.kill(); window.winScrolling = null; }
}

 /* ************************
  * consult 페이지 내 스크롤을 이동
  ************************ */
//클릭
function moveScrollTopItem01 () {
	$("html, body").animate({scrollTop: $("#consultItem01").offset().top - 150}, 600 ,"easeInOutExpo");
}
function moveScrollTopItem02 () {
	$("html, body").animate({scrollTop: $("#consultItem02").offset().top - 150}, 600 ,"easeInOutExpo");
}
function moveScrollTopItem03 () {
	$("html, body").animate({scrollTop: $("#consultItem03").offset().top - 150}, 600 ,"easeInOutExpo");
}
function moveScrollTopItem04 () {
	$("html, body").animate({scrollTop: $("#consultItem04").offset().top - 150}, 600 ,"easeInOutExpo");
}
function moveScrollTopItem05 () {
	$("html, body").animate({scrollTop: $("#consultItem05").offset().top - 150}, 600 ,"easeInOutExpo");
}
function moveScrollTopItem06 () {
	$("html, body").animate({scrollTop: $("#consultItem06").offset().top - 150}, 600 ,"easeInOutExpo");
}